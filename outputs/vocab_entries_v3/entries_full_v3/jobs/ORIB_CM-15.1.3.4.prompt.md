...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.3.3
CONTEXT_PREV_TEXT:
...
SOURCE_ID: ORIB_CM-15.1.3.4
TEXT:
Γιγγίδιον πικρότητός τε καὶ στύψεως μετέχει καὶ ξηραίνει κατ' ἀμφοτέρας τὰς ποιότητας, καὶ μέντοι καὶ εὐστόμαχόν ἐστιν.
