...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.26.5
CONTEXT_PREV_TEXT:
...
SOURCE_ID: ORIB_CM-15.1.26.6
TEXT:
οὗτος ὁ λίθος εἰς χυλὸν γαλακτώδη κατὰ τὴν χρόαν ἀνίεται, δακνώδης δ' ὑπάρχει γευομένοις.
