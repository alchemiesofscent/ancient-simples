...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.10.24
CONTEXT_PREV_TEXT:
τὸ μέντοι λέπος αὐτοῦ τὸ ξηρὸν καυθὲν λεπτομερές τε γίνεται καὶ ξηραντικὸν καὶ ἄδηκτον φάρμακον.
