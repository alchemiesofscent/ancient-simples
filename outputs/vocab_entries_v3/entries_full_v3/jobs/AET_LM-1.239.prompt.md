...
CONTEXT_PREV_SOURCE_ID: AET_LM-1.238
CONTEXT_PREV_TEXT:
...
SOURCE_ID: AET_LM-1.239
TEXT:
κυτίσου τὰ φύλλα διαφορητικῆς ἐστι δυνάμεως, ἐπιμεμιγμένης ὑδατώδει χλιαρᾷ, καθάπερ καὶ τὰ τῆς μαλάχης.
