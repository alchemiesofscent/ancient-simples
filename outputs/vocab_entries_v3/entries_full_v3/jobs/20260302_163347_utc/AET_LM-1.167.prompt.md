...
CONTEXT_PREV_SOURCE_ID: AET_LM-1.166
CONTEXT_PREV_TEXT:
...
SOURCE_ID: AET_LM-1.167
TEXT:
θύμβρα. Καὶ τὰ θύμβρα δὲ μάλιστα τὰ κηπευόμενα παραπλησίας μέν εἰσι δυνάμεως τῷ θύμῳ, ἀσθενεστέρας δὲ πολλῷ.
