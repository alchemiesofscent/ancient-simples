...
CONTEXT_PREV_SOURCE_ID: AET_LM-1.89
CONTEXT_PREV_TEXT:
...
SOURCE_ID: AET_LM-1.90
TEXT:
δίκταμνον λεπτομερέστερόν ἐστι τῆς γλήχωνος, τὰ δὲ ἄλλα παραπλήσιον αὐτῇ. τὸ δὲ ψευδοδίκταμνον ἀσθενέστερον.
