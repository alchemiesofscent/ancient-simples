...
CONTEXT_PREV_SOURCE_ID: AET_LM-1.84
CONTEXT_PREV_TEXT:
...
SOURCE_ID: AET_LM-1.85
TEXT:
γναφάλιον στυπτικῆς ἐστι μετρίως δυνάμεως καὶ διὰ τοῦτο διδόασιν αὐτὸ δυσεντερικοῖς μετὰ τινος τῶν αὐστηρῶν οἴνων.
