...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.10.18
CONTEXT_PREV_TEXT:
Κάρω θερμαίνει καὶ ξηραίνει κατὰ τὴν τρίτην που τάξιν, δριμεῖαν μετρίως ἔχουσα τὴν ποιότητα.
