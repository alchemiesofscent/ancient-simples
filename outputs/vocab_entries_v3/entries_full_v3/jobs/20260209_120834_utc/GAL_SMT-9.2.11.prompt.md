...
CONTEXT_PREV_SOURCE_ID: GAL_SMT-9.2.10
CONTEXT_PREV_TEXT:
...
SOURCE_ID: GAL_SMT-9.2.11
TEXT:
τῶν λίθων δ' ἐστὶ μία καὶ ἡ μαγνῖτις τε καὶ Ἡρακλεία καλουμένη, παραπλησίαν ἔχουσα τῷ αἱματίτῃ τὴν δύναμιν.
