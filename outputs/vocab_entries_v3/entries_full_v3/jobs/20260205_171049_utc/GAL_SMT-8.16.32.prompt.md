...
CONTEXT_PREV_SOURCE_ID: GAL_SMT-8.16.31
CONTEXT_PREV_TEXT:
...
SOURCE_ID: GAL_SMT-8.16.32
TEXT:
πολύκνημον ξηραίνει καὶ θερμαίνει κατὰ τὴν δευτέραν ἀπόστασιν, ὥστε καὶ διὰ τοῦτο τραυμάτων ἐστὶ κολλητικόν.
