...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.10.21
CONTEXT_PREV_TEXT:
...
SOURCE_ID: ORIB_CM-15.1.10.22
TEXT:
τηνικαῦτα δὲ καὶ διαφορητικὸν ἱκανῶς γίνεται, πρόσφατον δ' ὑπάρχον ἔχει τι καὶ στυφούσης ποιότητος.
