...
CONTEXT_PREV_SOURCE_ID: GAL_SMT-8.18.1
CONTEXT_PREV_TEXT:
...
SOURCE_ID: GAL_SMT-8.18.2
TEXT:
σάμψυχον λεπτομεροῦς ἐστι καὶ διαφορητικῆς δυνάμεως. ξηραίνει τε γάρ καὶ θερμαίνει κατὰ τὴν τρίτην τάξιν.
