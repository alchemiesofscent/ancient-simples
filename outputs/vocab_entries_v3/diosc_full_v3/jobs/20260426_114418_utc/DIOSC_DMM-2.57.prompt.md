...
CONTEXT_PREV_SOURCE_ID: DIOSC_DMM-2.56
CONTEXT_PREV_TEXT:
...
SOURCE_ID: DIOSC_DMM-2.57
TEXT:
ἐλέφαντος τὸ ἐκ τοῦ ὀδόντος ῥίνισμα παρωνυχίας καταπλασθὲν θεραπεύει, δύταμιν ἔχον στυπτικήν.
