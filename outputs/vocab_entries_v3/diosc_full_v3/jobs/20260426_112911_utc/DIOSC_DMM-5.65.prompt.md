...
CONTEXT_PREV_SOURCE_ID: DIOSC_DMM-5.64
CONTEXT_PREV_TEXT:
...
SOURCE_ID: DIOSC_DMM-5.65
TEXT:
καὶ μαραθίτης δὲ καὶ ἀνήθινος καὶ πετροσελινίτης ὁμοίως σκευάζονται, πρὸς τὰ αὐτὰ ποιοῦντες.
