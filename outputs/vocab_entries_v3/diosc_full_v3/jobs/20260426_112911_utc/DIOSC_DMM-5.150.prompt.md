...
CONTEXT_PREV_SOURCE_ID: DIOSC_DMM-5.149
CONTEXT_PREV_TEXT:
...
SOURCE_ID: DIOSC_DMM-5.150
TEXT:
λίθος γεώδης στύφει, ξηραίνει, ἀποκαθαίρει τὰ ἐπισκοτοῦντα ταῖς κόραις τῶν ὀφθαλμῶν. καταχρισθεὶς δὲ μεθ᾿ ὕδατος μαστῶν καὶ ὄρχεων παύει φλεγμονάς.
