...
CONTEXT_PREV_SOURCE_ID: PAUL_AEG-7.3.576
CONTEXT_PREV_TEXT:
...
SOURCE_ID: PAUL_AEG-7.3.577
TEXT:
Σόκχος στύφει τε καὶ σαφῶς ψύχει καταπλασσόμενός τε καὶ ἐσθιόμενος, ξηρανθεὶς δὲ μετρίως θερμαίνει.
