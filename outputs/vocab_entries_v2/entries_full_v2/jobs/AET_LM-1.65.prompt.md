...
CONTEXT_PREV_SOURCE_ID: AET_LM-1.64
CONTEXT_PREV_TEXT:
...
SOURCE_ID: AET_LM-1.65
TEXT:
βλίτον ἐδώδιμόν ἐστι λάχανον ὑγρὸν καὶ ψυχρὸν τῇ κράσει ἐν τῇ δευτέρᾳ μάλιστα ἀποστάσει τεταγμένον.
