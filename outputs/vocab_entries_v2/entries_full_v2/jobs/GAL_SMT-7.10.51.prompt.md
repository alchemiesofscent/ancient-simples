...
CONTEXT_PREV_SOURCE_ID: GAL_SMT-7.10.50
CONTEXT_PREV_TEXT:
...
SOURCE_ID: GAL_SMT-7.10.51
TEXT:
κραταιογόνου τῆς πόας ὁ καρπὸς καὶ δριμὺς γευομένοις ἐστὶ καὶ σφοδρῶς χρωμένοις, κέγχρῳ παραπλήσιος ὑπάρχων.
