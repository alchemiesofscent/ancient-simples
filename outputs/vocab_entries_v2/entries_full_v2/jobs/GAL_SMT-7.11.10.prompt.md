...
CONTEXT_PREV_SOURCE_ID: GAL_SMT-7.11.9
CONTEXT_PREV_TEXT:
λευκὰς δριμείας ἐστὶ ποιότητος ἐπικρατούσης, κράσεως δὲ θερμῆς καὶ ξηρᾶς κατὰ τὴν τρίτην που τάξιν.
