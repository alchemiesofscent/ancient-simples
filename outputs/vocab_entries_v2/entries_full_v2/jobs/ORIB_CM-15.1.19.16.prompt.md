...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.19.15
CONTEXT_PREV_TEXT:
...
SOURCE_ID: ORIB_CM-15.1.19.16
TEXT:
Τραγάκανθα παραπλησίαν ἔχει τῷ κόμμει δύναμιν, ἐμπλαστικήν τέ τινα καὶ δριμυτήτων ἀμβλυντικήν·
