...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.10.2
CONTEXT_PREV_TEXT:
...
SOURCE_ID: ORIB_CM-15.1.10.3
TEXT:
κείσθω τοίνυν δευτέρας τάξεως τῶν θερμαινόντων τε καὶ ξηραινόντων, καὶ σφοδρότερόν γε ξηραινόντων ἢ θερμαινόντων.
