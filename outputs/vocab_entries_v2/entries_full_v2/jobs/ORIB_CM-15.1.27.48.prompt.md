...
CONTEXT_PREV_SOURCE_ID: ORIB_CM-15.1.27.47
CONTEXT_PREV_TEXT:
...
SOURCE_ID: ORIB_CM-15.1.27.48
TEXT:
μεμάθηκας δὲ καὶ ὅτι πάντα τὰ κεκαυμένα πλυνόμενα μετριώτερα καὶ ἀδηκτότερα γίνεται.
