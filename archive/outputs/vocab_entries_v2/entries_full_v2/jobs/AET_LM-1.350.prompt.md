...
CONTEXT_PREV_SOURCE_ID: AET_LM-1.349
CONTEXT_PREV_TEXT:
...
SOURCE_ID: AET_LM-1.350
TEXT:
σάμψυχον λεπτομεροῦς ἐστι καὶ διαφορητικῆς δυνάμεως· ξηραίνει τε γὰρ καὶ θερμαίνει κατὰ τὴν τρίτην τάξιν.
