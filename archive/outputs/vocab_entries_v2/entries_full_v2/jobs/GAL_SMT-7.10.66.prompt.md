...
CONTEXT_PREV_SOURCE_ID: GAL_SMT-7.10.65
CONTEXT_PREV_TEXT:
...
SOURCE_ID: GAL_SMT-7.10.66
TEXT:
κυτίσου τὰ φύλλα διαφορητικῆς τ' ἐστὶ δυνάμεως ἐπιμεμιγμένης ὑδατώδει χλιαρᾷ, καθάπερ καὶ τὰ τῆς μαλάχης.
