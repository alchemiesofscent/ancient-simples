...
CONTEXT_PREV_SOURCE_ID: GAL_SMT-6.5.13
CONTEXT_PREV_TEXT:
...
SOURCE_ID: GAL_SMT-6.5.14
TEXT:
ἐπίθυμον τῆς θύμου δυνάμεώς ἐστιν ἰσχυρότερον, τὰ πάντα ξηραινούσης τε καὶ θερμαινούσης κατὰ τὴν τρίτην ἀπόστασιν.
